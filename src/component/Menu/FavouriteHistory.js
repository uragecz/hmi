            ...
            <div className="favouriteHistory">
                <svg style={this.props.css} id="menuOpen" className="modal-menu" width={452} height={452} >
                    ...
                    {this.props.current && length !== 0 ?
                        <g>
                            <path fill="none" stroke="rgb(237,146,78)" strokeWidth="4" d="M225,20 L225,30 L225,25 A200,200 0 0,0 55, 130"></path>
                            <path fill="rgb(237,146,78)" d="M45,125 A100,100 0 0,0 43,160 A100,100 0 0,1 70 137 A75,75 0 0,1 50,135" ></path>
                            <text  x={100} y={30} textAnchor="middle" fontFamily="sans-serif" fontSize="18px" fill="rgb(237,146,78)">{this.props.current}
                            </text>
                        </g>
                    : false}

                    <circle cx={this.state.center} cy={this.state.center} r="50" stroke="rgba(0,0,0,0.1)" strokeWidth="2" fill="rgb(237,146,78)" />
                    <text  textAnchor="middle" x={this.state.center} y={this.state.center+2} fontFamily="sans-serif" fontSize="12px" fill="white">{this.props.label}
                    </text>
                </svg>
            </div>
        )
