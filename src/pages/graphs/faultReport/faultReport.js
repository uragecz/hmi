...
class FaultReport extends Component{
    ...
    render(){
        ...
        return(
           <Page>
               <div className="item size-2-4">
                   <div className="element full">
                       <InputList data={text.nslt} modal={false} name="CTS" header={["Cuts","Absolute","/1000 Rh","/1000 km"]} multiple={true} type={["name","number1","number2","number3"]} list={this.state.cuts} />
                       <InputList data={text.slcmo} modal={false} name="QV" header={["Quality values","","/1000 m",""]} multiple={true} type={["name","number1","number2","number3"]} list={this.state.qualityValues} />
                   </div>
                   </div>
                   <div className="item size-2-4">
                   <div className="element full">
                       ...
                       <InputList data={text.slcmo} modal={false} name="TA" header={["Tech. Alarms","","",""]} multiple={true} type={["name","number1","number2","number3"]} list={this.state.techAlarms} />
                   </div>
               </div>
           </Page>
        )
